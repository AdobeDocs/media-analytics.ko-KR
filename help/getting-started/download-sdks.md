...
| [![확장 아이콘](assets/plug.svg)](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/web-sdk/overview.html?lang=ko)<br>[웹 SDK 태그 확장](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/web-sdk/overview.html?lang=ko) | [스트리밍 미디어용 웹 SDK 태그 확장 설정](/help/implementation/edge/web-sdk-tags.md) | [샘플](https://github.com/adobe/alloy-samples/blob/main/media-collection/TAGS_IMPL.md) |
...
| [![API 아이콘](assets/api.png)](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/)<br>[미디어 컬렉션 API](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/) | [미디어 컬렉션 API 설정](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/implementation) | |
