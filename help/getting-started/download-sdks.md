...
| ![JavaScript 아이콘](assets/javascript-icon.png) | 웹 - Experience Platform 에지(준비 중) |  | [Experience Platform 에지로 Analytics 설치](/help/implementation/implementation-edge.md) |  |
...
| ![Android 아이콘](assets/android-icon.png) | Android - Experience Platform 에지 | [Experience Platform 에지로 Analytics 설치](/help/implementation/implementation-edge.md) |  |
| ![Apple iOS 아이콘&#x200B;](assets/ios-icon.png)<br>**tvOS** | iOS / tvOS - Experience Platform 에지 | [Experience Platform 에지로 Analytics 설치](/help/implementation/implementation-edge.md) |  |
