...
| --- | --- | --- |
| 컨텐츠 | eVar <br>기본 만료: 방문 | 고유한 eVar 정의 |
| 컨텐츠 유형 | eVar <br>기본 만료: 페이지 보기 | 고유한 eVar 정의 |
| 컨텐츠 체류 시간 | 이벤트 <br>유형: 카운터 | 고유한 이벤트를 정의합니다. |
| 비디오 시작 | 이벤트 <br>유형: 카운터 | 고유한 이벤트를 정의합니다. |
| 비디오 완료 | 이벤트 <br>유형: 카운터 | 고유한 이벤트를 정의합니다. |
