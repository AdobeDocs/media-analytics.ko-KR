...
Experience Edge을 사용하는 XDM 기반 구현의 경우 [사용자 지정 메타데이터 지원 - XDM 형식](/help/implementation/edge/implementation-edge-custom-metadata.md)을 참조하십시오.
...
- [사용자 지정 메타데이터 지원 - XDM 형식](/help/implementation/edge/implementation-edge-custom-metadata.md) - 사용자 지정 메타데이터를 Experience Edge을 통해 Analytics와 AEP 모두에 보냅니다.
