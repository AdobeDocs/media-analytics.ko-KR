...
Media Collection API는 본질적으로 Media SDK의 서버 측 버전 역할을 하는 어댑터입니다. 수집된 스트리밍 미디어 추적 데이터는 동일한 [보고 및 분석](/help/implementation/media-sdk/setup/media-reports-enable.md)으로 이어집니다.
