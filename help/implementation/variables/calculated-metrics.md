---
title: 계산된 지표
description: 스트리밍 미디어 컬렉션 추가 기능의 계산된 지표 및 지표 공식에 대해 알아봅니다.
...
Adobe 스트리밍 미디어 컬렉션 추가 기능에 대한 계산된 지표는 평균 광고 체류 시간 또는 미디어 스트림당 평균 광고 수와 같은 타겟팅된 스트리밍 미디어 데이터를 얻을 수 있는 사용자 지정 지표입니다.
