...
| **XDM 컬렉션 필드** | [`xdm.mediaCollection.chapterDetails.index`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/chapter-details-collection) |
...
챕터 위치를 두 번째 인수(`position`)로 `adb_media_init_chapterinfo`에 전달합니다.
