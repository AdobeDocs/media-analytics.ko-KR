...
| **XDM 컬렉션 필드** | [`mediaCollection.advertisingDetails.advertiser`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/advertising-details-collection) |
| **필수** | 아니요 |
| **전송 시점** | 광고 시작, 광고 종료 |
