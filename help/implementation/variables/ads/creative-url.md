...
| **XDM 컬렉션 필드** | [`xdm.mediaCollection.advertisingDetails.creativeURL`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
표준 광고 메타데이터 개체에서 `MEDIA_AdMetadataKeyCREATIVE_URL`을(를) 사용하여 크리에이티브 URL을 설정합니다.
