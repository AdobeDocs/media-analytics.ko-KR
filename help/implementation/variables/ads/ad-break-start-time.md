...
| **XDM 컬렉션 필드** | [`mediaCollection.advertisingPodDetails.offset`](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/data-types/advertising-pod-details-collection) |
| **필수** | 예 |
| **전송 시점** | 광고 시작, 광고 종료 |
