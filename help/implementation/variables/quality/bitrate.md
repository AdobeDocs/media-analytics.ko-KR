...
| **XDM 컬렉션 필드** | [`mediaCollection.qoeDataDetails.bitrate`](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/data-types/qoe-data-details-collection) |
| **필수** | 아니요 |
| **전송 시점** | 품질 이벤트(비트율 변경, 버퍼, 오류), 세션 닫기 |
