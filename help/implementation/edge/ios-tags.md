---
title: 태그를 사용하는 스트리밍 미디어용 iOS 설정
...
# 태그를 사용하는 스트리밍 미디어용 iOS 설정

데이터 수집 UI에서 관리되는 미디어 설정으로 iOS 또는 tvOS 앱의 스트리밍 미디어 컬렉션을 태그 모바일 속성을 통해 구성할 수 있습니다. 이 페이지에서는 태그 구성에 대해 설명합니다. 대신 코드에서 SDK을 구성하려면 [스트리밍 미디어용 iOS 설정](ios.md)을 참조하십시오.
...
속성이 게시되고 추적기가 만들어진 상태에서 추적기 메서드를 사용하여 각 미디어 이벤트를 추적합니다. 정확한 호출은 각 [이벤트](/help/implementation/events/overview.md) 및 [변수](/help/implementation/variables/overview.md) 페이지에서 **iOS** 탭을 참조하십시오.
