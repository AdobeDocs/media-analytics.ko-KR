...
* **필수 구성 요소**:
   ...
   * 웹 SDK 2.20.0 이상을 설치합니다. [웹 SDK 설치](https://experienceleague.adobe.com/ko/docs/experience-platform/collection/js/install/overview)를 참조하십시오.
...
전체 구성에 대한 자세한 내용은 [`streamingMedia` 명령](https://experienceleague.adobe.com/ko/docs/experience-platform/collection/js/commands/configure/streamingmedia)을(를) 참조하십시오.

### Media JS SDK에서 마이그레이션

Media JS(3.x) SDK에서 이동하는 경우 웹 SDK [`getMediaAnalyticsTracker`](https://experienceleague.adobe.com/ko/docs/experience-platform/collection/js/commands/getmediaanalyticstracker) 명령은 [3.x Media SDK](/help/implementation/analytics-only/javascript.md)과(와) 동일한 API를 노출하는 추적기 인스턴스를 반환하므로 기존 추적 호출이 계속 작동합니다.
...
>[!MORELIKETHIS]
>
>* [Web SDK 개요](https://experienceleague.adobe.com/ko/docs/experience-platform/collection/js/js-overview)
