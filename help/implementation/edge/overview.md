...
**코드 내** 구현은 응용 프로그램 소스 코드에서 직접 SDK 호출을 작성합니다. **태그 사용** 구현에서는 응용 프로그램 코드를 수정하지 않고도 추적 규칙을 구성하고 배포할 수 있도록 해주는 [Adobe Experience Platform 태그](https://experienceleague.adobe.com/ko/docs/experience-platform/tags/home)를 사용합니다. 배포 워크플로에 적합한 접근 방식을 선택하십시오.
