...
**스트림 유형** 차원은 각 미디어 세션이 오디오 콘텐츠인지 비디오 콘텐츠인지를 캡처합니다. 보고서 세트에 대해 [미디어 코어가 활성화](/help/reporting/setup/analytics-reporting.md)되면 Adobe Analytics에서, 스트리밍 미디어 데이터를 포함하는 데이터 세트에 대해 Customer Journey Analytics에서 사용할 수 있습니다.
...
| 보고 시스템 | 소스 |
| --- | --- |
| Adobe Analytics | [[!UICONTROL 미디어 코어]](/help/reporting/setup/analytics-reporting.md)이(가) 활성화되면 컨텍스트 데이터 `a.media.streamType`에서 자동으로 수집됩니다. |
