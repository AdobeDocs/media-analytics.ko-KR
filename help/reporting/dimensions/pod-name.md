...
Pod 이름은 플레이어가 `media.adBreakStart`에 설정한 [광고 브레이크 이름](/help/implementation/variables/ads/ad-break-name.md) 값에서 가져온 것입니다.
...
각 항목은 `media.adBreakStart`에 보고된 리터럴 광고 브레이크 이름입니다.
