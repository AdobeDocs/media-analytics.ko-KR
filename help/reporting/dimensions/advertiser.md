...
`media.adStart` 이벤트마다 플레이어가 광고주를 설정합니다.
...
| Customer Journey Analytics | [`mediaReporting.advertisingDetails.advertiser`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/advertising-details-reporting) |
| 데이터 피드 | `videoadvertiser, post_videoadvertiser` |

## 차원 항목

각 항목은 `media.adStart`에 보고된 리터럴 광고주 이름입니다.
