...
광고 이름은 플레이어가 모든 `media.adStart` 이벤트에 설정합니다.
...
| Customer Journey Analytics | [`mediaReporting.advertisingDetails.friendlyName`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/advertising-details-reporting) |
...
각 항목은 `media.adStart`에 보고된 리터럴 광고 제목입니다(예: `"Ford F-150"`).
