...
| Adobe Analytics(분류) | [광고 pod](ad-pod.md) 차원의 분류 — 보고서 세트에 대해 **[[!UICONTROL 미디어 광고]](/help/reporting/setup/analytics-reporting.md)**&#x200B;를 사용하도록 설정하면 Adobe에서 이 분류를 자동으로 만듭니다. 분류 값을 채우고 유지 관리합니다. |
