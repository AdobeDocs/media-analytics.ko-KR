...
Pod의 광고 위치는 플레이어가 모든 `media.adStart` 이벤트에서 설정합니다.
...
| Customer Journey Analytics | [`mediaReporting.advertisingDetails.podPosition`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/advertising-details-reporting) |
| 데이터 피드 | `videoadinpod, post_videoadinpod` |

## 차원 항목

각 항목은 정수 위치 값(`0`, `1`, `2`, ...)입니다. `media.adStart`에 보고되었습니다.
