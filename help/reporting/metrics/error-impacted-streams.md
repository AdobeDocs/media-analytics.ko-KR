...
세션 중에 [오류](/help/implementation/events/error.md) 이벤트가 처음 수신되면 미디어 백엔드가 `mediaReporting.qoeDataDetails.hasErrorImpactedStreams = true`을(를) 설정합니다. 지표는 닫기 호출에 보고됩니다.
