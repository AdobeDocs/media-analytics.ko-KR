...
`media.adComplete` 이벤트가 수신되면 미디어 백엔드가 `mediaReporting.advertisingDetails.isCompleted = true`을(를) 설정합니다. 지표는 광고 닫기 호출에 보고됩니다. 생략되거나 포기된 광고는 완료로 계산되지 않습니다.
...
| Customer Journey Analytics | [`mediaReporting.advertisingDetails.isCompleted`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/advertising-details-reporting) |
