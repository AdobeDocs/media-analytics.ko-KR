...
`media.chapterComplete` 이벤트가 수신되면 미디어 백엔드가 `mediaReporting.chapterDetails.isCompleted = true`을(를) 설정합니다. 지표는 챕터 닫기 호출에 보고됩니다. 건너뛴 챕터 또는 포기한 중간 플레이는 완료로 계산되지 않습니다.
...
| Customer Journey Analytics | [`mediaReporting.chapterDetails.isCompleted`](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/data-types/chapter-details-reporting) |
