...
# 스트리밍 미디어용 Adobe Analytics 릴리스 정보 (2022년 9월)
...
| 기능 | 설명 | 목표 일자 |
| ----------- | ---------- | ------- |
| 미디어 컬렉션: Experience Edge(API 및 Mobile SDK)와 통합 | 이제 Experience Edge API 및 Mobile SDK를 사용하여 스트리밍 미디어를 구현할 수 있습니다. 이를 통해 보다 개인화된 캠페인을 빌드하고 더 개인화된 콘텐츠를 제공할 수 있으므로 보고해야 할 추적 데이터가 더 많이 제공됩니다.<p>이 개선 사항은 CJA 보고, RT-CDP, AJO 및 이벤트 전달과 같은 모든 솔루션에 걸쳐 통합된 수집 방법을 제공합니다.  [자세히 알아보기](/help/implementation/media-sdk/implementation-edge.md) | 2023년 5월 말 |
