...
1. 보낸 사람과 받은 사람은 함께 페더레이션 규칙 계약 양식을 작성합니다. **** 양식의 현재 버전은 다음 사이트에서 다운로드할 수 있습니다.페더레이션 [규칙 계약 양식.](/assets/federated_analytics_form.pdf) (이 양식에는 엔지니어링 팀의 특수 필드가 포함되어 있으며 Adobe Acrobat을 사용해서만 편집해야 합니다.) [Acrobat을 무료로 다운로드합니다.](https://get.adobe.com/reader/)
