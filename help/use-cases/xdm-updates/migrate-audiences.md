...
1. 이전 필드 간에 매핑하려면 [스트리밍 미디어 서비스](/help/media-overview.md)에 문서화된 스트리밍 미디어 변수를 참조하십시오. 이전 필드 경로는 &quot;XDM 필드 패스&quot; 속성에서 찾을 수 있고 새 필드 경로는 &quot;보고 XDM 필드 패스&quot; 속성에서 찾을 수 있습니다. 예를 들어 [Media Starts](/help/reporting/metrics/media-starts.md) 매개 변수의 경우 `media.mediaTimed.impressions.value`에 대한 대응 항목은 `mediaReporting.sessionDetails.isViewed`입니다.
