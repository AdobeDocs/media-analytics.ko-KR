...
description: 플레이헤드 타임라인과 해당 사용자의 작업에 대해 더 깊이 들여다보십시오. 각 작업과 그에 수반되는 요청에 대한 세부 사항을 알아보십시오.
...
필수 세션 매개 변수는 요청 본문의 `params` 맵에 포함해야 합니다. 세션에 대한 자세한 내용은 Media Collection API 설명서를 참조하십시오.
