...
| `ADBVideoMetadataKeyFIRST_AIR_DATE` | 최초 비행일 | 비디오 |
...
| `ADBVideoMetadataKeySHOW_TYPE` | 유형 표시 | 비디오 |
...
| `ADBAdMetadataKeyCREATIVE_ID` | Creative Id | 광고 |
| `ADBAdMetadataKeyPLACEMENT_ID` | 배치 Id | 광고 |
| `ADBAdMetadataKeySITE_ID` | 사이트 Id | 광고 |
| `ADBAdMetadataKeyCREATIVE_URL` | Creative Url | 광고 |
