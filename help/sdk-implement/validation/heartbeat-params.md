...
| s:sp:channel | MediaHeartbeatConfig | (선택 사항)<br/><br/>사용자가 컨텐츠를 보고 있는 채널입니다. 모바일 앱인 경우 앱 이름입니다. 웹 사이트인 경우 도메인 이름입니다. |
...
| s:asset:pod_id | Media SDK | (필수)<br/><br/>비디오 내부의 Pod ID입니다. 이 값은 다음 공식을 기반으로 하여 자동으로 계산됩니다. <br/>`MD5(video_id) + `<br/>`"_" + `<br/>`[pod index]` |
...
| l:stream:chapter_offset | ChapterInfo | (필수)<br/><br/>광고를 제외한 기본 컨텐츠 내에 있는 챕터의 오프셋(초 단위)입니다. |
