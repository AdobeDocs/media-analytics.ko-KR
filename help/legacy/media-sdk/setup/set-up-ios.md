...
* **응용 프로그램에서 iOS용 ADBMobile 구현**
Adobe Mobile SDK 설명서에 대한 자세한 정보는 [Experience Cloud 솔루션용 iOS SDK 4.x](https://experienceleague.adobe.com/docs/mobile-services/ios/overview.html?lang=ko)를 참조하십시오.
