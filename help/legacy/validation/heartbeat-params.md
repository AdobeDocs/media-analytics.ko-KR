...
| l:asset:지속 시간 / l:asset:length <br/>(길이 지속 시간에서 이름이 변경됨) | VideoInfo | (필수)<br/><br/>주 자산의 비디오 자산 길이입니다. |
...
| s:user:원조 | Experience Cloud 조직 | (선택 사항)<br/><br/>사용자의 Analytics 방문자 ID 값입니다. |
