...
* [Experience Cloud ID 확장](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html?lang=ko)
...
* ID3 메타데이터가 포함된 Nielsen DTVR(선형) 및 CMS 메타데이터가 포함된 DCR에 대한 통합 지원
