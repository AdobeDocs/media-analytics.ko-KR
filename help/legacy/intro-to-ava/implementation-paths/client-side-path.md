...
Media Analytics가 의도한 경로인 경우 [Media SDK 구현](/help/implementation/media-sdk-overview.md) 및 [Media Collection API](/help/implementation/media-collection-api/mc-api-overview.md)를 참조하십시오.
