...
이 설명서는 주로 Media Analytics 구현의 차이점에 중점을 둡니다
독립 실행형 Media SDK과 Media Analytics Launch 확장 간에 표시됩니다.

Launch는 고객에게 모든 분석을 배포하고 관리하는 간단한 방법을 제공합니다.
관련 고객을 지원하는 데 필요한 마케팅 및 광고 솔루션
웹 및 모바일에서 경험이 제공됩니다. Launch는 구축 및 유지 관리할 수 있는 권한을 누구에게나 부여합니다
launch와 자체 통합. 이러한 통합을 확장이라고 합니다.
확장은 앱 스토어 환경에서 Launch 고객이 사용할 수 있으므로,
는 해당 솔루션을 신속하게 설치, 구성 및 배포할 수 있습니다.
